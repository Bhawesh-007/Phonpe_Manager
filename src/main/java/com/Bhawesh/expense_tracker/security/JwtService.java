...
public class JwtService {
    ...
    public String generateToken(java.util.Map<String, Object> claims, UserDetails userDetails) {
        return Jwts.builder()
                .setClaims(claims)
    ...
    // 2. Extract the email from the token when they make a request later
